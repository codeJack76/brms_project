...
interface ClearanceFiltersProps {
  ...
  setClearanceTypeFilter: (type: string) => void;
  clearanceTypes: ClearanceType[];
  onNewClearance: () => void;
}

export default function ClearanceFilters({
  searchTerm,
  setSearchTerm,
  statusFilter,
  setStatusFilter,
  ...
  const statuses = ['All', 'Pending', 'Approved', 'Released', 'Rejected'];
